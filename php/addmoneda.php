...
<div class="container">
  <form action="addmoneda.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de moneda:</label>
      <input type="text" class="form-control" name="moneda" placeholder="Ingresar nombre de moneda" required="">
    </div>

    <div class="form-group">
      <label for="">Status</label>
      <input type="number" class="form-control" placeholder="Ingresar Status"  onKeyDown="return false" min="0" max="1" name="status7" value="<?php echo $comida['status7'] ?>"required="">
      0 = Oculto, 1 = Visible
    </div>

<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData8($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de impuesto</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de impuesto</h4>
</div><br> 
<div class="container">
  <form action="add_impuesto.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de impuesto:</label>
      <input type="text" class="form-control" name="impuesto" placeholder="Ingresar nombre de impuesto" required="">
    </div>

    <div class="form-group">
      <label for="nombre">Valor de impuesto:</label>
      <input type="text" class="form-control" onkeypress="return isNumber(event)" name="valor" placeholder="Ingresar valor de impuesto" required="">
    </div>

    <div class="form-group">
      <label for="">Status</label>
      <input type="number" class="form-control" placeholder="Ingresar Status"  onKeyDown="return false" min="0" max="1" name="status9" value="<?php echo $comida['status9'] ?>"required="">
      0 = Oculto, 1 = Visible
    </div>

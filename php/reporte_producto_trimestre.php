...
function Header()
{
    ...
    // Título
    $this->Cell(70,10,utf8_decode('Reporte de 5 productos que generaron  '),0,0,'C');
    $this->Cell(-70,30,utf8_decode('un mayor número de ingresos durante el primer trimestre de 2023'),0,0,'C');
    // Salto de línea
    $this->Ln(20);
...
$key = 28;
$pdf->Image('../img/Doc1.png',-20,50,250);

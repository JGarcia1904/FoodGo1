<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData4($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de subcategoria</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de subcategoria</h4>
</div><br> 
<div class="container">
  <form action="add_subcategoria.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de subcategoria:</label>
      <input type="text" class="form-control" name="subcategoria" placeholder="Ingresar subcategoria" required="">
    </div>

    <div class="form-group">
      <label for="">Status</label>
      <input type="number" class="form-control" placeholder="Ingresar Status"  onKeyDown="return false" min="0" max="1" name="status5" value="<?php echo $comida['status5'] ?>"required="">
      0 = Oculto, 1 = Visible
    </div>

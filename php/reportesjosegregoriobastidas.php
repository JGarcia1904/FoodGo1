...
function Header()
{
    ...
    $this->Cell(70,10,utf8_decode('Reporte de 3 urbanizaciones de la Parroquia José Gregorio Bastidas '),0,0,'C');
...
$header = array('Nombre de urbanizaciones',utf8_decode('Número de usuarios'));
 
// Get data from the text files
$data = $pdf->getDataFrmFile('employees5.txt');

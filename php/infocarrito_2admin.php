          ...
          <table class="table table-bordered table-striped text-center">
            <thead>
              ...
              <tr>
                ...
                <th>Precio Total</th>
                <th>
                  <a href="../control/axion_admin.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('¿Seguro que quieres vaciar tu carrito?');"><i class="fas fa-trash"></i>&nbsp;&nbsp;Limpiar carrito</a>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="../control/axion_admin.php?remove=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('¿Seguro que quieres retirar este producto?');"><i class="fas fa-trash-alt"></i></a>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="3">
                  <a href="carrito_2admin.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continuar
                    Comprando</a>
                </td>
                <td colspan="2"><b>Gran Total</b></td>
                <td><b><i class="fas fa-dollar-sign"></i>&nbsp;&nbsp;<?= number_format($monto,2); ?></b></td>
                <td>
                  <a href="../control/checkout_admin.php" class="btn btn-info <?= ($monto > 1) ? '' : 'disabled'; ?>"><i class="far fa-credit-card"></i>&nbsp;&nbsp;Checkout</a>
                </td>
              </tr>
            </tbody>
          </table>

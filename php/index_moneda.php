...
<div class="card text-center" style="padding:15px;">
  <h4>Tabla de Moneda para Pagos</h4>
</div><br><br> 
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              La moneda fue añadida exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
             La información de la moneda fue actualizada exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Moneda borrada de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de tipo de moneda
    <a href="addmoneda.php" class="btn btn-primary" style="float:right;">Añadir nueva moneda</a>
</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->lectura_moneda(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['moneda'] ?></td>
          <td><?php echo $comida['status7'] ?></td>
          <td>
            <a href="edit_moneda.php?editId=<?php echo $comida['id'] ?>" style="color:green">

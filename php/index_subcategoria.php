...
<html lang="en">
<head>
  <title>Cambios de Subcategoría</title>
  <meta charset="utf-8">
...
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              La subcategoria de producto fue añadida exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              La subcategoria de producto fue actualizada exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Subcategoria borrada de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de subcategorias
    <a href="add_subcategoria.php" class="btn btn-primary" style="float:right;">Añadir nueva subcategoria de producto</a>
</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->lectura_subcategoria(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['subcategoria'] ?></td>
          <td><?php echo $comida['status5'] ?></td>
          <td>
            <a href="edit_subcategoria.php?editId=<?php echo $comida['id'] ?>" style="color:green">

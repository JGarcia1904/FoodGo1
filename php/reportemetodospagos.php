...
function Header()
{
    ...
    $this->Cell(70,10,utf8_decode('Reporte de 5 usuarios'),0,0,'C');
    $this->Cell(-70,30,utf8_decode('con mayor número de compras en Abril de 2023'),0,0,'C');
    // Salto de línea
    $this->Ln(30);
...
$header = array('Nombre del usuario',utf8_decode('Número de compras realizadas'));
 
// Get data from the text files
$data = $pdf->getDataFrmFile('employees1.txt');

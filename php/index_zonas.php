...
<html lang="en">
<head>
  <title>Información de zonas</title>
  <meta charset="utf-8">
  ...
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              La zona fue añadida exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              La información de la zona fue actualizada exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Zona borrada de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de zonas de residencia
    <a href="add_zonas.php" class="btn btn-primary" style="float:right;">Añadir nueva zona</a>
  </h2>
  <table class="table table-hover">
    <thead>
      <tr>
        ...
        <th>Imagen de zona</th>
        <th>Descripción de zona</th>
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->mostrarzona(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['nom_zona'] ?></td>
          <td><?php echo $comida['img'] ?></td>
          <td><?php echo $comida['info_zona'] ?></td>
          <td><?php echo $comida['status3'] ?></td>
          <td>
            <a href="edit_zonas.php?editId=<?php echo $comida['id'] ?>" style="color:green">

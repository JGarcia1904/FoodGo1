...
<html lang="en">
<head>
  <title>Información de bancos</title>
  <meta charset="utf-8">
...
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              El banco fue añadido exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              La información del banco fue actualizada exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Banco borrado de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de bancos
    <a href="add_bancos.php" class="btn btn-primary" style="float:right;">Añadir nuevo banco</a>
  </h2>
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->mostrarbanco(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['nom_banco'] ?></td>
          <td><?php echo $comida['num_cuenta'] ?></td>
          <td><?php echo $comida['rif'] ?></td>
          <td><?php echo $comida['tipo'] ?></td>
          <td><?php echo $comida['tlf'] ?></td>
          <td><?php echo $comida['img'] ?></td>
          <td><?php echo $comida['status2'] ?></td>
          <td>
            <a href="edit_bancos.php?editId=<?php echo $comida['id'] ?>" style="color:green">

...
<div class="card text-center" style="padding:15px;">
  <h4>Tabla de Tamaños de Productos</h4>
</div><br><br> 
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              El tamaño de producto fue añadido exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              El tamaño de producto fue actualizado exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Tamaño borrado de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de tamaño de producto
    <a href="add_tamaño.php" class="btn btn-primary" style="float:right;">Añadir nuevo tamaño de producto</a>
</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->lectura_tamaño(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['tamaño'] ?></td>
          <td><?php echo $comida['status4'] ?></td>
          <td>
            <a href="edit_tamaño.php?editId=<?php echo $comida['id'] ?>" style="color:green">

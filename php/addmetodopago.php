<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData5($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de método de pago</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de método de pago</h4>
</div><br> 
<div class="container">
  <form action="addmetodopago.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de método de pago:</label>
      <input type="text" class="form-control" name="nom_metodo" placeholder="Ingresar nombre de método de pago" required="">
    </div>

    <div class="form-group">
      <label for="">Status</label>
      <input type="number" class="form-control" placeholder="Ingresar Status"  onKeyDown="return false" min="0" max="1" name="status6" value="<?php echo $comida['status6'] ?>"required="">
      0 = Oculto, 1 = Visible
    </div>

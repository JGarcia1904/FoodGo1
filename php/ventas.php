          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <form action="reportes.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    <div class="col">
                      <span>Desde:</span>
                      <input type="date" name="fecha_ingreso" max="<?=date('Y-m-d')?>" class="form-control"  placeholder="Fecha de Inicio" required>
                    </div>
                    <div class="col">
                      <span>Hasta:</span>  
                      <input type="date" name="fechaFin" max="<?=date('Y-m-d')?>" class="form-control" placeholder="Fecha Final" required>
                    </div>
                    <div class="col">

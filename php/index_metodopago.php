...
<html lang="en">
<head>
  <title>Cambios de Método de Pago</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Tabla de Métodos de Pagos</h4>
</div><br><br> 
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              El método de pago fue añadido exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              El método de pago fue actualizado exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Método de pago borrado de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de método de pago
    <a href="addmetodopago.php" class="btn btn-primary" style="float:right;">Añadir nuevo método de pago</a>
</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->lectura_metodopago(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['nom_metodo'] ?></td>
          <td><?php echo $comida['status6'] ?></td>
          <td>
            <a href="edit_metodopago.php?editId=<?php echo $comida['id'] ?>" style="color:green">

...
function Header()
{
    ...
    $this->SetX(25);
    $this->Cell(80,15,'Nombre',1,0,'C',1);
	$this->Cell(50,15,'Precio',1,0,'C',1);
	$this->Cell(50,15,utf8_decode('Código de img'),1,1,'C',1);
...
while ($row=$resultado->fetch_assoc()) {
    $pdf->SetX(25);
	$pdf->Cell(80,15,utf8_decode($row['nombre']),1,0,'C',0);
	$pdf->Cell(50,15,$row['precio']."$",1,0,'C',0);
	$pdf->Cell(50,15,$row['img'],1,1,'C',0);

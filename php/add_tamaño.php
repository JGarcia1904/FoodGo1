<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData3($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de tamaño</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de tamaño</h4>
</div><br> 
<div class="container">
  <form action="add_tamaño.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de tamaño:</label>
      <input type="text" class="form-control" name="tamaño" placeholder="Ingresar nombre de tamaño" required="">
    </div>

    <div class="form-group">
      <label for="">Status</label>
      <input type="number" class="form-control" placeholder="Ingresar Status"  onKeyDown="return false" min="0" max="1" name="status4" value="<?php echo $comida['status4'] ?>"required="">
      0 = Oculto, 1 = Visible
    </div>

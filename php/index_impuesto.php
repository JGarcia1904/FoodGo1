...
<html lang="en">
<head>
  <title>Cambios de Impuestos</title>
  <meta charset="utf-8">
...
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              El impuesto fue añadido exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              El impuesto fue actualizado exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Impuesto borrado de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de impuesto
    <a href="add_impuesto.php" class="btn btn-primary" style="float:right;">Añadir nuevo impuesto</a>
</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->lectura_impuesto(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['impuesto'] ?></td>
          <td><?php echo $comida['valor'] ?></td>
          <td><?php echo $comida['status9'] ?></td>
          <td>
            <a href="edit_impuesto.php?editId=<?php echo $comida['id'] ?>" style="color:green">

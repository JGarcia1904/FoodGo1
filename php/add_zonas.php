<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData2($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de zona de residencia</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de zona de residencia</h4>
</div><br> 
<div class="container">
  <form action="add_zonas.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de zona:</label>
      <input type="text" class="form-control" name="nom_zona" placeholder="Ingresar nombre de zona de residencia" required="">
    </div>
    <div class="form-group">
      <label for="nombre">Descripción de zona:</label>
      <input type="text" class="form-control" name="info_zona" placeholder="Ingresar descripción de zona de residencia" required="">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" onKeyDown="return false" min="0" max="1" name="status3" placeholder="Ingresar Status" required="">
      0 = Oculto, 1 = Visible
    </div>

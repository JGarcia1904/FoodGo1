<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData1($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de banco</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de banco</h4>
</div><br> 
<div class="container">
  <form action="add_bancos.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de banco:</label>
      <input type="text" class="form-control" name="nom_banco" placeholder="Ingresar nombre de banco" required="">
    </div>
    <div class="form-group">
      <label for="nombre">Número de cuenta:</label>
      <input type="text" onkeypress="return checkNumber(event)" class="form-control" name="num_cuenta" placeholder="Ingresar número de cuenta" required="">
    </div>
    <div class="form-group">
      <label for="nombre">RIF:</label>
      <input type="text" class="form-control" name="rif" placeholder="Ingresar RIF del banco" required="">
    </div>
    <div class="form-group">
      <label for="nombre">Tipo de cuenta:</label>
      <input type="text" class="form-control" name="tipo" placeholder="Ingresar tipo de cuenta" required="">
    </div>
    <div class="form-group">
      <label for="nombre">Número teléfonico:</label>
      <input type="text" onkeypress="return checkNumber(event)" min=11 max=11 class="form-control" name="tlf" placeholder="Ingresar número telefónico" required="">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" onKeyDown="return false" min="0" max="1" name="status2" placeholder="Ingresar Status" required="">
      0 = Oculto, 1 = Visible
    </div>

...
<div class="container">
 ...
 if (isset($_GET['msg3']) == "delete") {
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <form action="reportes3.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    <!-- <div class="col">
                      <span>Desde:</span>
  ...
  <table class="table table-hover" id="tableEmpleados">
    ...
    <tbody>
        <?php 
          $deliverys = $deliveryObj->lectura_comida(); 
          foreach ($deliverys as $delivery) {
        ?>
        <tr>
          <td><?php echo $delivery['nombre'] ?></td>
          <td><?php echo $delivery['precio'] ?></td>
          <td><?php echo $delivery['img'] ?></td>
          <!-- <td>

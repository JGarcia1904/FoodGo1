...
function Header()
{
    ...
    // Título
    $this->Cell(70,10,utf8_decode('Reporte de 3 zonas de delivery con un mayor  '),0,0,'C');
    $this->Cell(-70,30,utf8_decode('número de pedidos durante el primer trimestre de 2023'),0,0,'C');
    // Salto de línea
    $this->Ln(20);
...
$key = 28;
$pdf->Image('../img/Doc2.png',-20,50,230);

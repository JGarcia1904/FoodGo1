...
CREATE TABLE `antecedentes` (
  `codigo_de_identificacion_de_antecendentes` int NOT NULL AUTO_INCREMENT,
  `ci_pasiente` int DEFAULT NULL,
  `antecedentes_personales` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `antecedentes_familiares` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo_de_identificacion_de_antecendentes`),
  KEY `ci_pasiente` (`ci_pasiente`),
  CONSTRAINT `FK__paciente` FOREIGN KEY (`ci_pasiente`) REFERENCES `paciente` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO antecedentes VALUES("40","27349806","vacio","vacio");
INSERT INTO antecedentes VALUES("45","25513198","vacio","vacio");
INSERT INTO antecedentes VALUES("49","929129","  ","  alzaimer");
...
INSERT INTO bancos VALUES("6","ZELLE","0","xxxxxxxxxxxx","xxxxxxxxxxxx","xxxx","xxxxxxxxxx","100.jpg");
INSERT INTO bancos VALUES("7","TAL","0","x","x","x","x","x");
...
CREATE TABLE `ciudad` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombres_ciudad` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO ciudad VALUES("1","	Caracas");
INSERT INTO ciudad VALUES("2","	Maracaibo");
INSERT INTO ciudad VALUES("3","	Valencia");
INSERT INTO ciudad VALUES("4","	Barquisimeto");
INSERT INTO ciudad VALUES("5","Maracay");
INSERT INTO ciudad VALUES("6","Ciudad Guayana");
INSERT INTO ciudad VALUES("7","	Maturín");
INSERT INTO ciudad VALUES("8","Barinas");
INSERT INTO ciudad VALUES("9","San Cristóbal");
INSERT INTO ciudad VALUES("10","	Ciudad Bolívar");
INSERT INTO ciudad VALUES("11","	Barcelona");
INSERT INTO ciudad VALUES("12","Cumaná");
INSERT INTO ciudad VALUES("13","	Cabimas");
INSERT INTO ciudad VALUES("14","	Mérida");
INSERT INTO ciudad VALUES("15","	Puerto La Cruz");



CREATE TABLE `consulta` (
  `codigo_consulta` int NOT NULL AUTO_INCREMENT,
  `ci_de_paciente` int DEFAULT NULL,
  `fecha_de_consulta` date DEFAULT NULL,
  `motivo_de_consulta` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo_consulta`),
  KEY `ci_de_paciente` (`ci_de_paciente`),
  CONSTRAINT `FK_consulta_paciente` FOREIGN KEY (`ci_de_paciente`) REFERENCES `paciente` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO consulta VALUES("45","27349806","2023-05-07","vacio");
INSERT INTO consulta VALUES("50","25513198","2023-05-08","vacio");
INSERT INTO consulta VALUES("53","929129","2023-05-19","  ");
...
CREATE TABLE `diagnostico_presuntivo` (
  ...
  `codigo_de_consulta` int DEFAULT NULL,
  `diagnostico_sindromatico` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `diagnostico_nosologico` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tratamiento` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo_diagnostico`),
  KEY `codigo_de_consulta` (`codigo_de_consulta`),
  CONSTRAINT `consulta` FOREIGN KEY (`codigo_de_consulta`) REFERENCES `consulta` (`ci_de_paciente`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO diagnostico_presuntivo VALUES("4","27349806","vacio","vacio","vacio");
INSERT INTO diagnostico_presuntivo VALUES("9","25513198","","","");
INSERT INTO diagnostico_presuntivo VALUES("12","929129","  perreo intenso","  toda la noche ","   dejar de bailar");



CREATE TABLE `examen_funcional` (
  `id_examen_funcional` int NOT NULL AUTO_INCREMENT,
  `exanen_funcional` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_de_consulta` int DEFAULT NULL,
  PRIMARY KEY (`id_examen_funcional`),
  KEY `codigo_de_consulta` (`codigo_de_consulta`) USING BTREE,
  CONSTRAINT `FK1 codigo_de_consulta` FOREIGN KEY (`codigo_de_consulta`) REFERENCES `consulta` (`ci_de_paciente`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO examen_funcional VALUES("34","vacio","27349806");
INSERT INTO examen_funcional VALUES("39","vacio","25513198");
INSERT INTO examen_funcional VALUES("42","  ","929129");



CREATE TABLE `examenes_laboratorio` (
  `id_examenes` int NOT NULL AUTO_INCREMENT,
  `resultados_de_laboratorio` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cedula` int DEFAULT NULL,
  `fecha_laboratorio` date DEFAULT NULL,
  `tipo_examen` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_examenes`),
  KEY `codigo_de_diagnostico` (`cedula`) USING BTREE,
  CONSTRAINT `FK_examenes_laboratorio_paciente` FOREIGN KEY (`cedula`) REFERENCES `paciente` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO examenes_laboratorio VALUES("48","vacio","27349806","2023-05-07","Hematología completa,Glicemia en ayunas,Triglicéridos");
INSERT INTO examenes_laboratorio VALUES("53","vacio","25513198","0001-01-01","Sin examenes");
INSERT INTO examenes_laboratorio VALUES("56","  ","929129","2023-05-19","Hematología completa,Glicemia en ayunas,Creatinina");



CREATE TABLE `exploracion` (
  `id_exploracion` int NOT NULL AUTO_INCREMENT,
  `exploracion_fisica` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_consulta` int DEFAULT NULL,
  PRIMARY KEY (`id_exploracion`),
  KEY `codigo_consulta` (`codigo_consulta`),
  CONSTRAINT `codigo_de_consulta` FOREIGN KEY (`codigo_consulta`) REFERENCES `consulta` (`ci_de_paciente`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO exploracion VALUES("20","vacio","27349806");
INSERT INTO exploracion VALUES("25","vacio","25513198");
INSERT INTO exploracion VALUES("28","  ","929129");



CREATE TABLE `imagenologia` (
  `id_imagenologia` int NOT NULL AUTO_INCREMENT,
  `resultados_imagenologia` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cedula_paciente` int DEFAULT NULL,
  `fecha_imagenologia` date DEFAULT NULL,
  PRIMARY KEY (`id_imagenologia`),
  KEY `codigo_de_diagnostico` (`cedula_paciente`) USING BTREE,
  CONSTRAINT `FK_imagenologia_paciente` FOREIGN KEY (`cedula_paciente`) REFERENCES `paciente` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO imagenologia VALUES("51","vacio","27349806","2023-05-07");
INSERT INTO imagenologia VALUES("56","vacio","25513198","0001-01-01");
INSERT INTO imagenologia VALUES("60","  ","929129","2023-05-19");
...
CREATE TABLE `medico` (
  `cedula` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `p_nombre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `p_apellido` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `mpps` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mcm` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`cedula`),
  KEY `cedula` (`cedula`),
  CONSTRAINT `FK_medico_usuario` FOREIGN KEY (`cedula`) REFERENCES `usuario` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO medico VALUES("26556514","enrique","gonzalez","casa","04125106352","12931","98217");
...
INSERT INTO metodo VALUES("3","Paguito","0");
INSERT INTO metodo VALUES("4","No","0");
...
INSERT INTO moneda VALUES("3","Yuanes","0");
INSERT INTO moneda VALUES("4","Euros","0");
...
INSERT INTO ordenes VALUES("33","a","11111111","a","Barquisimeto-Oeste","11111111111","10","1","11111111","a","2023-05-20","MERCANTIL","Sandwich Grill(1)","Transferencita","Bolívares");
INSERT INTO ordenes VALUES("34","a","11111111","a","Barquisimeto-Oeste","11111111111","3","1","11111111","a","2023-05-20","PROVINCIAL","Sandwich doble(1)","Transferencita","Bolívares");
INSERT INTO ordenes VALUES("35","javier","27349806","casa","Cabudare-Parroquia","04263531266","2","1","27349806","javier","2023-05-20","PROVINCIAL","clasico(1)","Transferencita","Bolívares");
...
CREATE TABLE `paciente` (
  `cedula` int NOT NULL,
  `p_nombre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `s_nombre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `p_apellido` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `s_apellido` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  CONSTRAINT `FK__ciudad` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudad` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO paciente VALUES("929129","a","a","a","a","2023-05-19","4","77777777777");
INSERT INTO paciente VALUES("25513198","annelys","gabriela","chavez","caruci","1995-03-04","4","11111111111");
INSERT INTO paciente VALUES("27349806","javier","agustin","garcia","caruci","2000-03-19","4","01021032101");
...
CREATE TABLE `usuario` (
  `cedula` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `clave` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  PRIMARY KEY (`cedula`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO usuario VALUES("26556514","12345");
...
INSERT INTO zonas VALUES("1","Barquisimeto-Oeste","1","Empezando desde la calle 42 con carrera 18, siguiendo la ruta según la dirección: Carrera 19, Pedro León Torres, Florencio Jiménez y Metropolis","oeste.jpg");
...
INSERT INTO zonas VALUES("7","prueba","0","a","100.jpg");

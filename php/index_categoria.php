...
<html lang="en">
<head>
  <title>Cambios de Categoría</title>
  <meta charset="utf-8">
...
<div class="container">
  <?php
    if (isset($_GET['msg1']) == "insert") {
      echo "<div class='alert alert-success alert-dismissible'>
              ...
              La categoria de producto fue añadida exitosamente
            </div>";
      } 
    if (isset($_GET['msg2']) == "update") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              La categoria de producto fue actualizada exitosamente
            </div>";
    }
    if (isset($_GET['msg3']) == "delete") {
      echo "<div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              Categoria borrada de manera exitosa
            </div>";
    }
  ?>
  <h2>Ver registro de categorias
    <a href="add_categoria.php" class="btn btn-primary" style="float:right;">Añadir nueva categoria de producto</a>
</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php 
          $comidas = $comidaObj->lectura_categoria(); 
          foreach ($comidas as $comida) {
        ?>
        <tr>
          <td><?php echo $comida['id'] ?></td>
          <td><?php echo $comida['categoria'] ?></td>
          <td><?php echo $comida['status8'] ?></td>
          <td>
            <a href="edit_categoria.php?editId=<?php echo $comida['id'] ?>" style="color:green">

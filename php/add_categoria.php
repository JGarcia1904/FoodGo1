<?php
  ...
  if(isset($_POST['submit'])) {
    $comidaObj->insertData7($_POST);
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Añadir info de categoria</title>
  <meta charset="utf-8">
...
<div class="card text-center" style="padding:15px;">
  <h4>Añadir info de categoria</h4>
</div><br> 
<div class="container">
  <form action="add_categoria.php" method="POST">
    <div class="form-group">
      <label for="nombre">Nombre de categoria:</label>
      <input type="text" class="form-control" name="categoria" placeholder="Ingresar categoria" required="">
    </div>

    <div class="form-group">
      <label for="">Status</label>
      <input type="number" class="form-control" placeholder="Ingresar Status"  onKeyDown="return false" min="0" max="1" name="status8" value="<?php echo $comida['status8'] ?>"required="">
      0 = Oculto, 1 = Visible
    </div>
